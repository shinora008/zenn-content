...
毎回、ファシリテーター（以下、ファシリ）を交代制で担当します。
...
これまでに輪読した書籍の一例として、
[「ソフトウェアアーキテクチャの基礎」](https://www.oreilly.co.jp//books/9784873119823/)を取り上げました。
